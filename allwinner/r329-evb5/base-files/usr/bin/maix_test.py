...
async def main(packet):
    if packet["selected"] == 114:
        ...
        os.system('mjpg_streamer -i "input_uvc.so -d /dev/video0 -r 320x240" -o "output_file.so -m test.jpg" &')
        await asyncio.sleep(0.3)
        os.system('fbviewer /tmp/test.jpg &')
        ...
        draw.text((40, 120), 'Music Test', fill=(255, 0, 0))
        canvas.show()
        os.system('arecord -d 2 -t wav -r 44100 -f S32_LE > /tmp/test.wav')
